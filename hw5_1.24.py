...
def depth_search(graph, start):
    ...
    """
    when next_tier comes up with nothing, it needs to return '' to kill the while loop
    
    each node needs to be added to covered
    
    objects = next_tier(objects)    needs to function properly
